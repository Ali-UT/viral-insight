...
exports.remixScript = exports.analyzeVideo = void 0;
...
exports.remixScript = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'The function must be called while authenticated.');
    }
    ...
    - TOP TONES: ${analysis.tones ? analysis.tones.map((t) => t.label).join(', ') : 'N/A'}
